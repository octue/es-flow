...
void filter(Eigen::ArrayBase<DerivedOut> & y, const Eigen::ArrayBase<DerivedIn>& b, const Eigen::ArrayBase<DerivedIn>& a, const Eigen::ArrayBase<DerivedIn>& x) {
...
void deconv(Eigen::ArrayBase<DerivedOut>& z, const Eigen::ArrayBase<DerivedIn> &b, const Eigen::ArrayBase<DerivedIn> &a) {
